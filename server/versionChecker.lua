        ...
        if statusCode == 200 then
            ...
            if data and data.tag_name then
                ...
                if latestVersion ~= currentVersion then
                    print('╭────────────────────────────────────────────────────╮')
                    printCentered('[Muhaddil_Infections] - New Version Available', boxWidth, '34') -- Blue
                    ...
                    print('╭────────────────────────────────────────────────────╮')
                    printWrapped('[Muhaddil_Infections] - Up-to-date', boxWidth, '32')  -- Green
                    printWrapped('Current version: ' .. currentVersion, boxWidth, '32') -- Green
                    print('╰────────────────────────────────────────────────────╯')
                end
            else
                printWithColor('[Muhaddil_Infections] - Error: The JSON structure is not as expected.', '31') -- Red
                printWithColor('GitHub API Response: ' .. response, '31')                                     -- Red
            end
        else
            printWithColor('[Muhaddil_Infections] - Failed to check for latest version. Status code: ' .. statusCode,
                '31') -- Red
            printWithColor('[Muhaddil_Infections] - GitHub might be having issues',
                '31') -- Red
        end
    end, 'GET')
end
